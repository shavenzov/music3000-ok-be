...
class BaseDataService{
   ...
   protected $LOGIN    = 'tralala_ok';//'approxi_tralala';
   protected $PASSWORD = 's5*kbks#jKLL';//'hrr455_pogb';
   protected $DB       = 'tralala_ok';//'approxi_tralala';
   ...
   protected $publications_table = 'publications';
